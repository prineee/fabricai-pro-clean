  ...
  return (
    <DashboardLayout>
      ...
      <p style={{ color: "#fef08a", fontSize: "16px", marginBottom: "32px" }}>
        Generate professional blog posts instantly
      </p>

      <div style={{ maxWidth: "820px" }}>
        <label style={{ display: "block", color: "#fef08a", fontSize: "15px", fontWeight: 600, marginBottom: "8px" }}>
          Blog Topic
        </label>
        <input
          type="text"
          placeholder="e.g. AI trends in garment manufacturing"
          value={topic}
